...
class MusicAPI{
    ...
    public function search($s,$limit=30,$offset=0,$type=1){
        $url='http://music.163.com/weapi/search/pc?csrf_token=';
        $data=array(
            's'=>$s,
            'type'=>$type,
            'limit'=>$limit,
    ...
    public function artist($artist_id){
        $url='http://music.163.com/weapi/artist/'.$artist_id.'?csrf_token=';
        $data=array(
            'csrf_token'=>'',
        );
        return $this->curl($url,$this->prepare($data));
    ...
    public function detail($song_id){
        $url='http://music.163.com/weapi/song/detail?csrf_token=';
